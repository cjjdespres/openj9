...
public:
   ...
   template<class R> static R *readRecord(JITServerAOTCacheReadContext &context);
...
private:
   ...
   template<class R> friend R *AOTCacheRecord::readRecord(JITServerAOTCacheReadContext &context);

   AOTCacheClassLoaderRecord(uintptr_t id, const uint8_t *name, size_t nameLength);
   AOTCacheClassLoaderRecord(JITServerAOTCacheReadContext &context, const ClassLoaderSerializationRecord &header) {}
...
private:
   ...
   bool setSubrecordPointers(JITServerAOTCacheReadContext &context);
