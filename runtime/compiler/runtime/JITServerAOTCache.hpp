...
public:
   ...
   // space. The getThunkRecord method instead has an accompanying storeThunk method that will create and store
   ...
   const AOTCacheThunkRecord *storeThunk(const uint8_t *signature, uint32_t signatureSize, const uint8_t *thunkCode, uint32_t thunkCodeSize);
